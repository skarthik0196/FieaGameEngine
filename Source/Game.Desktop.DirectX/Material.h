...
namespace Rendering
{
	...
	public:
		...
		void CreateTexture(ID3D11Device2* D3Ddevice, const std::wstring& filePath, Texture::TextureFileType fileType, Texture::TextureType textureType = Texture::TextureType::Diffuse);
